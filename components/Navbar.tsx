...
export default function Navbar() {
  ...
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      ...
      Object.keys(dropdownRefs).forEach((menu) => {
        ...
        const currentDropdownElement = dropdownRefs[key].current;

        if (
          dropdownOpen[key] &&
          currentDropdownElement &&
          !currentDropdownElement.contains(target as Node)
        ) {
          closeDropdown(key);
        }
      });
  ...
  return (
    <header
      className={`w-full transition-all duration-300 ${scrolled ? "bg-opacity-95 backdrop-blur-md shadow-lg" : ""} shadow-lg sticky top-0 z-50`}
    >
      {/* Top Navbar */}
      <div
        ...
        style={{
          ...
          backgroundImage: "linear-gradient(to right, #5D0000, #800000)",
        }}
      >
        {/* Mobile Menu Button */}
        <div
      ...
      <nav
        ...
        style={{
          ...
          backgroundImage: "linear-gradient(to right, #400000, #600000)",
        }}
      >
          ...
          <AnimatePresence>
            {mobileMenuOpen && (
              <motion.div
                ...
                className="absolute top-full left-0 right-0 bg-maroon-800 shadow-lg z-20"
              ...
              >
                <div className="flex flex-col p-4 space-y-4">
                  <Link
                    ...
                    className="font-bold text-white hover:text-yellow-300 transition-colors duration-300 py-2"
                  >
                    HOME
                  </Link>
                  ...
                  <div className="border-t border-gray-700 pt-2">
                    ...
                    {dropdownOpen.profil && (
                      <div className="pl-4 mt-2 space-y-2">
                        ...
                        <Link
                          href="/profil/struktur_organisasi"
                          onClick={() => setMobileMenuOpen(false)}
                          className="block text-gray-300 hover:text-yellow-300"
                        >
                          Struktur Organisasi
                  ...
                  <div className="border-t border-gray-700 pt-2">
                    ...
                    {dropdownOpen.prodi && (
                      <div className="pl-4 mt-2 space-y-2">
                        ...
                        <Link
                          href="/prodi/d4-teknologi-kimia-industri"
                          onClick={() => setMobileMenuOpen(false)}
                          className="block text-gray-300 hover:text-yellow-300"
                        >
                        ...
                        <Link
                          href="/prodi/s2-energi-terbarukan"
                          onClick={() => setMobileMenuOpen(false)}
                          className="block text-gray-300 hover:text-yellow-300"
                        >
                        ...
                        <Link
                          href="/prodi/d3-teknik-kimia-psdkusiak"
                          onClick={() => setMobileMenuOpen(false)}
                          className="block text-gray-300 hover:text-yellow-300"
                        >
                  ...
                  <div className="border-t border-gray-700 pt-2">
                    ...
                    {dropdownOpen.lab && (
                      <div className="pl-4 mt-2 space-y-2">
                        ...
                        <Link
                          href="/laboratorium/lab-miniplant"
                          onClick={() => setMobileMenuOpen(false)}
                          className="block text-gray-300 hover:text-yellow-300"
                        >
                  ...
                  <div className="border-t border-gray-700 pt-2">
                    ...
                    {dropdownOpen.direktori && (
                      <div className="pl-4 mt-2 space-y-2">
                        ...
                        <Link
                          href="https://sisak1.polsri.ac.id/"
                          onClick={() => setMobileMenuOpen(false)}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="block text-gray-300 hover:text-yellow-300"
